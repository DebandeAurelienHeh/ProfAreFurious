...
class Push(pygame.sprite.Sprite):
    '''
    Classe de création de Push

    Attributs:
    ---------
    image: Surface
        Chargement de l'image de Push

    image: Surface scale
        Redimension de l'image de Push

    rect: RectType
        Mise d'un rectangle pour les collisions autour de l'image Push
